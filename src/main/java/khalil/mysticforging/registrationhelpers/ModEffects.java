...
import khalil.mysticforging.effects.LavaSwimEffect;
...
public class ModEffects {
        ...
        public static final RegistryEntry<StatusEffect> DIGGER = registerStatusEffect("digger",
                        new LavaSwimEffect(StatusEffectCategory.BENEFICIAL, 0x8B4513));
